 ...
 * @author  mfahim
 */
public class issueLoyalityCard extends javax.swing.JFrame {

    /** Creates new form ProductFrame */
    public issueLoyalityCard() {
        initComponents();
    ...
    public issueLoyalityCard(JFrame f,String uStatus,String user) {
        initComponents();
...
private void newSaleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newSaleActionPerformed
    issueLoyalityCard nSaleFrame = new issueLoyalityCard(this,userStatus.getText(),systemUser.getText());
