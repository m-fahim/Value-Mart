 ...
 * @author  mfahim
 */
public class renewMember extends javax.swing.JFrame {
    ...
    public renewMember(JFrame f,String uStatus,String user) {
        initComponents();
...
private void newSaleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newSaleActionPerformed
    renewMember nSaleFrame = new renewMember(this,userStatus.getText(),systemUser.getText());
