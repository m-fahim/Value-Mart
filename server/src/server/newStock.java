...
public class newStock extends javax.swing.JFrame {
    ...
    public newStock(JFrame f,String uStatus,String user) {
        initComponents();
        this.setTitle(this.getClass().getSimpleName());
...
private void placeOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_placeOrderActionPerformed
    newStock pOrderFrame = new newStock(this,userStatus.getText(),systemUser.getText());
...
private void newProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newProductActionPerformed
    newStock nProFrame = new newStock(this,userStatus.getText(),systemUser.getText());
