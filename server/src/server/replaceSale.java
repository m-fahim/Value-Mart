 ...
 * @author  mfahim
 */
public class replaceSale extends javax.swing.JFrame {
    ...
    public replaceSale(JFrame f,String uStatus,String user) {
        initComponents();
...
private void newSaleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newSaleActionPerformed
    replaceSale nSaleFrame = new replaceSale(this,userStatus.getText(),systemUser.getText());
