 ...
 * @author  mfahim
 */
public class cancelMember extends javax.swing.JFrame {
    ...
    public cancelMember(JFrame f,String uStatus,String user) {
        initComponents();
...
private void newSaleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newSaleActionPerformed
    cancelMember nSaleFrame = new cancelMember(this,userStatus.getText(),systemUser.getText());
