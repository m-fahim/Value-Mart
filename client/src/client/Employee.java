...
public static  int find_employees_id(String s) throws SQLException{
    Database dBB = new Database();
    ResultSet rss = dBB.exeQry("Select * from employee where employee_username = '"+s+"' ");
    rss.next();
    return Integer.parseInt(rss.getString("employee_id"));
}
