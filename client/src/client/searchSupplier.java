...
public class searchSupplier extends javax.swing.JFrame {
    ...
    public searchSupplier(JFrame f,String uStatus,String user) {
        initComponents();
        this.setTitle(this.getClass().getSimpleName());
...
private void newProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newProductActionPerformed
    searchSupplier nProFrame = new searchSupplier(this,userStatus.getText(),systemUser.getText());
...
private void updateProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateProductActionPerformed
    searchSupplier uProFrame = new searchSupplier(this,userStatus.getText(),systemUser.getText());
