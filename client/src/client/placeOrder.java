...
public class placeOrder extends javax.swing.JFrame {
    ...
    public placeOrder(JFrame f,String uStatus,String user) {
        initComponents();
        this.setTitle(this.getClass().getSimpleName());
        userStatus.setText(uStatus);
        systemUser.setText(user);
        this.setIconImage(Toolkit.getDefaultToolkit().getImage("src/images/icon.png"));
        rsProList = Order.find_all_order();
        ResultSet rsMetaData = Order.find_all_order();
        
        int  li_row = 0;
        try {
            tColNo = rsMetaData.getMetaData().getColumnCount();
            ...
            ResultSet rsTol = Order.find_all_order();
            while(rsTol.next()){
                tOrder = tOrder + Integer.parseInt( rsTol.getString("or_total"));
            }
            listGrandTotal.setText(""+tOrder);
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(this,"Error :: In finding Products "+ex);
        }
        Dimension screen = Toolkit.getDefaultToolkit().getScreenSize();  
        Rectangle recframe = getBounds();  
        setLocation((screen.width - recframe.width)/2, (screen.height - recframe.height)/2);  
    ...
    private void initComponents() {
        ...
        listNoTotal = new javax.swing.JLabel();
        listGrandTotal = new javax.swing.JLabel();
        ...
        productList.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "", "ID", "Name", "Employee ID", "Product ID", "Quantity", "Total"
            }
        ));
        ...
        listNoTotal.setFont(new java.awt.Font("Tahoma", 1, 11));

        listGrandTotal.setFont(new java.awt.Font("Tahoma", 1, 11));
        ...
        layout.setVerticalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                .add(57, 57, 57)
                .add(mainContent1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 100, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
...
proPlaceOrder pPOrder = new proPlaceOrder(this,userStatus.getText(),systemUser.getText(),getProName);
    ...
    private javax.swing.JLabel listGrandTotal;
    private javax.swing.JLabel listNoTotal;
