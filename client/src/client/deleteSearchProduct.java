 ...
 * @author  mfahim
 */
public class deleteSearchProduct extends javax.swing.JFrame {

    /** Creates new form ProductFrame */
    public deleteSearchProduct() {
        initComponents();
    ...
    public deleteSearchProduct(JFrame f,String uStatus,String user , String delProN) {
        initComponents();
        this.setTitle(this.getClass().getSimpleName());
        ...
        try {
            ...
            Logger.getLogger(deleteSearchProduct.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        proDelete.setFont(new java.awt.Font("Tahoma", 1, 11));
...
private void proDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_proDeleteActionPerformed
 ...
 p.set_category_id(Integer.parseInt(getCateID));
 p.set_product_description(proDes.getText());
 if(JOptionPane.showConfirmDialog(this, "Are you sure to Delete this Product.") == 0){
     this.resetFields();
     Boolean result = p.delete_product(this.delProName);
     if(result == false){
