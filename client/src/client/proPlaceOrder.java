 ...
 * @author  mfahim
 */
public class proPlaceOrder extends javax.swing.JFrame {

    /** Creates new form ProductFrame */
    public proPlaceOrder() {
        initComponents();
    ...
    public proPlaceOrder(JFrame f,String uStatus,String user , String delProN) {
        initComponents();
        this.setTitle(this.getClass().getSimpleName());
        ...
        f.dispose();
        try {
            if (!deleteProduct(delProN)) {
                this.setVisible(false);
                JOptionPane.showMessageDialog(this, "Error :: Product not exists.");
            ...
            Logger.getLogger(proPlaceOrder.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        orQuan = new javax.swing.JTextField();
        jLabel15 = new javax.swing.JLabel();
        orName = new javax.swing.JTextField();
        proQ = new javax.swing.JTextField();
        ...
        proDelete.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        proDelete.setText("Order it");
        ...
        proMan.setEditable(false);

        proVariety.setEditable(false);
        ...
        jLabel15.setText("Order Name : ");

        proQ.setEditable(false);
        ...
        mainContent2Layout.setHorizontalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, mainContent2Layout.createSequentialGroup()
                .add(28, 28, 28)
                .add(mainContent2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                        ...
                        .add(mainContent2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            ...
                            .add(mainContent2Layout.createSequentialGroup()
                                ...
                                .add(mainContent2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                                    ...
                                    .add(jLabel15, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 94, Short.MAX_VALUE))))
                        .add(mainContent2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(mainContent2Layout.createSequentialGroup()
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(mainContent2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                                    .add(proMan)
                                    .add(org.jdesktop.layout.GroupLayout.TRAILING, proSize, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 170, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                    .add(proBrand)
                                    .add(proName, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 143, Short.MAX_VALUE)))
                            .add(mainContent2Layout.createSequentialGroup()
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(mainContent2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                    .add(org.jdesktop.layout.GroupLayout.TRAILING, orQuan, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 170, Short.MAX_VALUE)
                                    .add(orName, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 170, Short.MAX_VALUE)))))
                    .add(mainContent2Layout.createSequentialGroup()
                        .add(jLabel16, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 94, Short.MAX_VALUE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(proQ, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 170, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                .add(37, 37, 37)
            ...
            .add(mainContent2Layout.createSequentialGroup()
                ...
                .add(mainContent2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    ...
                    .add(mainContent2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(mainContent2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                            .add(proQ, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(jLabel16))
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .add(mainContent2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                            .add(jLabel15)
                            .add(orName, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(mainContent2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                            .add(jLabel14)
                            .add(orQuan, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 19, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                        .add(22, 22, 22))))
        );
...
private Boolean deleteProduct(String upPro) throws SQLException {                                         
  rsDelete = Product.find_product_name(upPro);
            if (rsDelete.next()) {
                proName.setText(rsDelete.getString("product_name"));
                proBrand.setText(rsDelete.getString("product_brand"));
                proMan.setText(rsDelete.getString("product_manufacture"));
                proSize.setText(rsDelete.getString("size"));
                proVariety.setText(rsDelete.getString("variety"));
                proDes.setText(rsDelete.getString("product_description"));
                proQ.setText(rsDelete.getString("quantity"));
                return true;
            }
            else
                return false;
}
private void upProduct(int quan){                                         
    Product.update_product_quantity(proName.getText(),Integer.parseInt(proQ.getText())- quan);                         
}
private void proDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_proDeleteActionPerformed
  if(Integer.parseInt(orQuan.getText()) <= Integer.parseInt(proQ.getText())){
    Order o = new Order();
    rsDelete = Product.find_product_name(proName.getText());
  try{
            if (rsDelete.next()) {
                o.set_product_id(Integer.parseInt(rsDelete.getString("product_id")));
                int pric = Integer.parseInt(rsDelete.getString("price"));
                int cate = Integer.parseInt(rsDelete.getString("category_id"));
                o.set_or_name(orName.getText());
                int quan = Integer.parseInt(orQuan.getText());
                o.set_or_quantity(quan);
                o.set_or_total(quan*pric);
                int empID = new Integer(Employee.find_employees_id(systemUser.getText()));
                o.set_employee_id(empID);
                this.upProduct(quan);
                o.insert_order();
      ...
      JOptionPane.showMessageDialog(this, "Order Quantity is greater than the Products in stock");
  }
}                                         
...
private void proCateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_proCateActionPerformed
        ...
        while(rsCate.next()){
            getCateID = rsCate.getString("category_id");
...
private void searchStockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchStockActionPerformed
    ...
    private ResultSet rsDelete ; 
    private String delProName;
    ...
    private javax.swing.JTextField orQuan;
    ...
    private javax.swing.JTextField proQ;
