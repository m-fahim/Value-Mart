 ...
 * @author  mfahim
 */
public class updateSearchProduct extends javax.swing.JFrame {
    ...
    public updateSearchProduct(JFrame f,String uStatus,String user , String upProN) {
        initComponents();
        this.setTitle(this.getClass().getSimpleName());
        ...
        try {
            ...
            Logger.getLogger(updateSearchProduct.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        proUpdate.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        newProCancel.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
...
private Boolean updateProduct(String upPro) throws SQLException {                                         
  rsUpdate = Product.find_product_name(upPro);
            if (rsUpdate.next()) {
                proName.setText(rsUpdate.getString("product_name"));
                proBrand.setText(rsUpdate.getString("product_brand"));
                proMan.setText(rsUpdate.getString("product_manufacture"));
                proSize.setText(rsUpdate.getString("size"));
                proVariety.setText(rsUpdate.getString("variety"));
                proDes.setText(rsUpdate.getString("product_description"));
                return true;
            }
            else
                return false;
...
private void proUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_proUpdateActionPerformed
 ...
 Boolean result = p.update_product(this.upProName);
            if(result == false){
                JOptionPane.showMessageDialog(this, "Error :: In Updating product.");
             }else{
                newProCancelActionPerformed(evt);
