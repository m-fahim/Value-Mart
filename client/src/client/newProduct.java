...
public class newProduct extends javax.swing.JFrame {
    ...
    public newProduct(JFrame f,String uStatus,String user) {
        initComponents();
        this.setTitle(this.getClass().getSimpleName());
...
private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
 ...
 p.set_product_description(proDes.getText());
        try {
            result = p.insert_product_client();//GEN-LAST:event_saveBtnActionPerformed
            if(result == false){
                JOptionPane.showMessageDialog(this, "Error :: In New product is insertion.");
             }else{
                cancelOrderActionPerformed(evt);
                JOptionPane.showMessageDialog(this, "New product is inserted Successfully.");
            }
        } catch (Exception ex) {
