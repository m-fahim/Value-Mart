...
public class updateProduct extends javax.swing.JFrame {
    ...
    public updateProduct() {
        ...
        try {
            while (rsProList.next()) {
                productList.setValueAt(rsProList.getString(1), li_row, 0);
                productList.setValueAt(rsProList.getString(2), li_row, 1);
                li_row++;
            }
    ...
    public updateProduct(JFrame f,String uStatus,String user) {
        initComponents();
        this.setTitle(this.getClass().getSimpleName());
        rsProList = Product.find_all_products();
        int  li_row = 0;
    ...
    private void initComponents() {
        ...
        searchProName = new javax.swing.JTextField();
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, mainContent1Layout.createSequentialGroup()
                ...
                .add(mainContent1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    .add(mainContent1Layout.createSequentialGroup()
                        .add(jLabel11)
                        .add(18, 18, 18)
                        .add(searchProName, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 159, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
...
private void sProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sProductActionPerformed
   updateSearchProduct uSPro = new updateSearchProduct(this,userStatus.getText(),systemUser.getText(),searchProName.getText());
    ...
    private javax.swing.JTextField searchProName;
