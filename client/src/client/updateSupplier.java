...
public class updateSupplier extends javax.swing.JFrame {
    ...
    public updateSupplier(JFrame f,String uStatus,String user) {
        initComponents();
        this.setTitle(this.getClass().getSimpleName());
...
private void newProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newProductActionPerformed
    updateSupplier nProFrame = new updateSupplier(this,userStatus.getText(),systemUser.getText());
...
private void newSupplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newSupplierActionPerformed
    updateSupplier nSupFrame = new updateSupplier(this,userStatus.getText(),systemUser.getText());
